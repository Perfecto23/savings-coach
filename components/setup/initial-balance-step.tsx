...
export function InitialBalanceStep({
  ...
  return (
    <div>
      <p className="text-sm font-medium text-orange-700">Checkpoint 3 of 3</p>
      ...
      <p className="mt-3 max-w-lg text-base leading-7 text-stone-600">
        Record what is in <strong className="font-semibold text-stone-900">{account.name}</strong>
        {account.institution ? ` at ${account.institution}` : ""}. This is a
        balance observation, not a transfer.
      </p>
      ...
      <form action={formAction} className="mt-8 space-y-6">
        ...
        <div>
          ...
          <p id="setup-balance-help" className="mt-2 text-sm leading-6 text-stone-500">
            Enter an amount in {preferences.baseCurrency}. Use no more than two
            decimal places.
          </p>
          <FieldError
        ...
        <div>
          ...
          <p id="setup-recorded-at-help" className="mt-2 text-sm leading-6 text-stone-500">
            Today in {preferences.timeZone} is {today}.
          </p>
          <FieldError
